...
module.exports = (function () {
    ...
    function loadControllersFrom(src) {
        ...
        // !!!!! To do...
        /**
         * If path is undefined or a string path
         */
        const folder = src ? 
            src
            : path.join(__dirname, '/controllers')
            
        fs.readdir(folder, (err, lst) => {
            if(err) throw err
            lst
     ...
     * route parameters.  
     */
    function parseMethodName(ctrMethod) {
        let parts = ctrMethod.name.toLowerCase().split('_')
        /**
     ...
     */
    function RouteInfo(ctrMethod) {
        this.path = parseMethodName(ctrMethod)
